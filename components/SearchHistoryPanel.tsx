    ...
    <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-5">
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-1.5">
          ...
          <h2 className="text-sm font-semibold text-ink">Busquedas recientes</h2>
        </div>
        <button
          onClick={() => {
            clearSearchHistory();
      ...
      <div className="flex flex-wrap gap-1.5">
        {entries.map((e) => (
          <button
            ...
            className="text-xs px-2.5 py-1.5 rounded-lg border border-slate-200 text-slate-600 hover:border-indigo/60 hover:text-indigo transition-colors"
